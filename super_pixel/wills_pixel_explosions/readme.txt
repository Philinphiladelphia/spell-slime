...
Hello, fellow game developer! Thank you for downloading Will's Pixel Explosions. Here are a few pointers to help you navigate and make sense of this zip file.

---TIPS AND TRICKS---

- In the main folder, you'll see 1 folder for each animation. I've tried to name them as descriptively as I can!

- Each animation has 4 different color styles.
	- style_A = original (orange / red)
	- style_B = green
	- style_C = blue
	- style_D = violet

- In each color style folder, you'll find a "PNG" folder. This is where the individual frames of the animation are.

- In each color style folder, you'll also find a folder called "spritesheet." In this folder is all the individual frames packed into one image. The accompanying text file is metadata describing where each frame is on the spritesheet.
The metadata format is:
(frame name) = x y width height

- If you want to make your own particle effects, the basic particles are included in the particles folder.
