...
Version 2.0 (3/1/18)
	...
	- Added 2 additional color themes.
	- Added spritesheets.
...
Hello! Thank you for purchasing the Mechanical Fortress tileset. Here are a few pointers to help you navigate and make sense of this zip file.

- In the main folder, you will find folders corresponding to each style for this tileset.

- In any of the style folders, you will find a folder named PNG. This folder contains all the objects, backgrounds, and tiles as descriptively-named PNGs.

- In the style folders, you will also find a folder named spritesheet. This folder contains the spritesheet (PNG) and two choices of metadata format (JSON or TXT) for reading the spritesheet. (Pick the format you like!)

- The format for the TXT spritesheet is as follows: name = x y width height

- The terrain animation is 100ms/frame. (10 FPS)

- The bg3 animation is 200ms/frame. (5 FPS)
